...
from components.option_list_widgets import LeftListWidget
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.left_sidebar_listwidget = LeftListWidget(self, self.centralwidget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 812, 518))
        ...
        self.cover_pic_label = QtWidgets.QLabel(self.below_bar_frame)
        self.cover_pic_label.setMinimumSize(QtCore.QSize(55, 55))
        self.cover_pic_label.setMaximumSize(QtCore.QSize(55, 55))
        self.cover_pic_label.setText("")
        self.cover_pic_label.setObjectName("label")
        self.horizontalLayout_8.addWidget(self.cover_pic_label)
        ...
        self.progress_labe.setFont(font)
        self.progress_labe.setLayoutDirection(QtCore.Qt.LeftToRight)
